...
function makeSandwiches(...items : string[]){console.log("Making a Sandwitch which contains following items :\n");
...
let my_car = CreatCar("Toyota", "Corrola", "colour: Black", "Sun-roof: True");
