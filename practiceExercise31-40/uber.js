...
var userName = ["Ali", "Sara", "Kamran", "Admin", "Usman"];
userName = [];
...
var curent_users = ["faiza", "aisha", "Salman", "Farida", "Rashid"];
// array for new uerss
var new_users = ["Danish", "Sarah", "Faiza", "Aisha", "Wajeeha"];
//loop for availibility of username
new_users.forEach(function (oneNewUser) {
    var our_condition = curent_users.some(function (current_one_user) { return current_one_user.toLowerCase() === oneNewUser.toLowerCase(); });
    if (our_condition) {
        console.log("Sorry ".concat(oneNewUser, " is already taken"));
    }
    else {
        console.log("Sorry ".concat(oneNewUser, " is available"));
    }
});
...
//creating an array
var pizzasName = ["chicken Tikka", "fajita", "malai boti"];
//using for loop
for (var _a = 0, pizzasName_1 = pizzasName; _a < pizzasName_1.length; _a++) {
    var onePizza = pizzasName_1[_a];
    console.log("hello, I like to eat ".concat(onePizza, " pizza"));
}
...
//creating an array
var petAnimal = ["cat", "dog", "cow"];
// use a for loop to print name
for (var _b = 0, petAnimal_1 = petAnimal; _b < petAnimal_1.length; _b++) {
    var onePat = petAnimal_1[_b];
    console.log("A ".concat(onePat, " would make a great pet "));
...
function make_shirt(size, printMessage) {
    console.log("The size of shit is ".concat(size, "  and ").concat(printMessage, " printed on it"));
}
// call the function
...
function make_shirts(size, pritedMessage) {
    if (size === void 0) { size = "large"; }
    if (pritedMessage === void 0) { pritedMessage = "I love TypeScript"; }
    console.log("the shirt size is ".concat(size, " and ").concat(pritedMessage, " is printed on it"));
}
// call the function
make_shirts();
make_shirts("medium");
...
//creating function
function describe_city(name, countryName) {
    if (countryName === void 0) { countryName = "Pakistan"; }
    console.log("".concat(name, " is in ").concat(countryName));
}
...
function city_country(name, countryName) {
    return "".concat(name, ", ").concat(countryName);
}
...
var album1 = make_album("Ali", "satrangi");
var album2 = make_album("Muskan", "album title2");
//callig a make_album function with third parameter
var album3 = make_album("faiza", "sahil", 3);
