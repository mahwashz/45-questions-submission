...
let persons_name :string = "Ahmed";
console.log(persons_name);
console.log(`Hello ${persons_name}, would you like to learn some Python today?`);
...
let goodName : string= "wajiha ajaz alavi";
console.log(goodName.toLowerCase());
console.log(goodName.toUpperCase());
console.log(goodName.replace(/\b\w/g , (jia)=> jia.toUpperCase()));
...
let message: string ="once said a person who never made amistake never tried any thing new";
...
//Question 5:Famous Quote 2: Repeat Exercise 4, but this time store the famous person’s name in a variable called famous_person. Then compose your message and store it in a new variable called message. Print your message.
 let famous_person :string = "Ahmed hussain kirmani";
 let message1 : string = "Goog morning, have a nice day.";
 console.log(`Hello ${famous_person}, ${message1}`);
 console.log(famous_person.toLowerCase());
 console.log(famous_person.toUpperCase());
 console.log(famous_person.replace(/\b\w/g, (ammo) => ammo.toUpperCase()));
...
let personNameWithWhiteSpaces : string = "\n\t Wajiha Ajaz Alavi \t\n";
let abdcf = " \t\n taha ajaz alavi \n\t";
let personNameWitouthWhiteSpaces =personNameWithWhiteSpaces.trim();
...
let message4: string = " My favorite number is"
